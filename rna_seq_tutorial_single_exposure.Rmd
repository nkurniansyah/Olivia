...
```
After looking at a few transcript counts, we infer that the data was normalized already, because the counts are not natural numbers. We ignore this fact and continue demonstrating the pipeline. 
