...
#'
#' @param count_matrix: A p \times n matrix of counts of p transcripts across n individuals. 
#' 
#'                         example :
...
#'           median expression count in the sample for a transcript. Default is NULL.
...
#'
#' @return Matrix of transcript counts, with filtered (reduced) rows.
