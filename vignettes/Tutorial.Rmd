...
In order to generate p-values under the null, we create a ``residual permuted" trait 100 times and perform differential expression analysis, and use the resulting p-values as our null p-values. However, users also can implement Storey emperical p-value, as these are reffered to in the manuscript). ). 
