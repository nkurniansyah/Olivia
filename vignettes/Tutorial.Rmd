...
storey_emp_multi<-lm_mult_count_mat_emp_pval(clean_count_matrix, pheno=phenotypes, traits="Trait.1,Trait.2", 
...
We show how we perform differential expression analysis on selected transcripts using permutation method. we suggested to run 100000 permutation for single genes.
